...
@Entity
@Table(name = "Customers_deals", 
		uniqueConstraints=@UniqueConstraint(columnNames = {"id_customer","name_good","price","quantity","sum","date_deal"}))
public class Customers_deals {
    ...
    public Customers_deals() {

    }

    public Customers_deals(int id, int id_customer, String name_good, Long price, int quantity, 
	...
	@Override
	public int hashCode() {
		return Objects.hash(dataset, date_deal, details, id, id_customer, last_changed, last_user, name_good, price,
				quantity, sum);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Customers_deals other = (Customers_deals) obj;
		return dataset == other.dataset && Objects.equals(date_deal, other.date_deal)
				&& Objects.equals(details, other.details) && id == other.id && id_customer == other.id_customer
	...
	public String toString() {
		return "Customers_deals [id=" + id + ", id_customer=" + id_customer + ", name_good=" + name_good + ", price="
