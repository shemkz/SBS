...
<script>
        ...
        var data = [{name: "Alex", share: 20.70}, 
                    <c:forEach items="${listSuppliers_by_sum_10}" var="s">
        			{name: "${s.first_name} ${s.last_name}",  share:${s.suppliers_sum}},
    				</c:forEach>
								];
        var g = svg.append("g")
...
<td>
	<form name="myform" >
            <table  name="mytable" id="mytable" border="1" width="600px" height="50px"  style="width:500px">
				...
				<c:forEach var="sup" items="${listSuppliers_by_sum}" varStatus="i">
                    <tr>
						...
						<td><input type="text" class="digits" name="suppliers_sum${i.index}" value="${sup.suppliers_sum}" disabled></td>
                    </tr>
				</c:forEach>
            </table>    
	</form>
