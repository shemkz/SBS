...
function new_row(){
	...
	cell3.innerHTML = `<select class="types" name="measureS` + minusI + `"><option  selected value="Прочее">Прочее</option><c:forEach items="${listMeasure}" var="m"><option value="${m}">${m}</option></c:forEach></select>`;
	...
	http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	var params="p1=Goods&p2=Прочее&p3=0&p4=0&p5=0";
	http.send(params);
