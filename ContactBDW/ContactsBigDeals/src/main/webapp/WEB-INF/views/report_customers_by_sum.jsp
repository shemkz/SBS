...
<br>
<h1>Report: Customers by sum of deals</h1>
<br>
<h2>Pie Chart</h2>
<br>
    <svg width="1000" height="800"></svg> <!--Step 2-->
<script>
        ...
        var data = [//{name: "Alex", share: 20.70}, 
                    <c:forEach items="${listCustomers_by_sum_10}" var="s">
        			{name: "${s.first_name} ${s.last_name}",  share:${s.customers_sum}},
    				</c:forEach>
								];
        var g = svg.append("g")
	...
	<form name="myform" >
            <table  name="mytable" id="mytable" border="1" width="600px" height="50px"  style="width:500px">
				...
				<c:forEach var="sup" items="${listCustomers_by_sum}" varStatus="i">
                    <tr>
						...
						<td><input type="text" class="digits" name="customers_sum${i.index}" value="${sup.customers_sum}" disabled></td>
                    </tr>
				</c:forEach>
            </table>    
	</form>
