...
uniqueConstraints= {// @UniqueConstraint(columnNames = {"type_name", "TIN"}),
					@UniqueConstraint(columnNames = {"type_name", "mobile_p"}),
					@UniqueConstraint(columnNames = {"type_name", "first_name", "middle_name", "last_name"}) })
public class Suppliers {
    ...
    public Suppliers(int id, String type_name, String first_name, String middle_name, String last_name, String TIN, 
	...
	public void setDate_create(LocalDate dt) {
		this.date_create = dt;
	}
	...
	public String toString() {
		return "Suppliers [id=" + id + ", type_name=" + type_name + ", first_name=" + first_name + ", middle_name="
